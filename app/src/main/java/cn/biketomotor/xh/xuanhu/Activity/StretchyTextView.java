...
public class StretchyTextView extends LinearLayout implements View.OnClickListener {
    ...
    public StretchyTextView(Context context, AttributeSet attrs) {
        ...
        contentText = view.findViewById(R.id.content_textview);
        operateText =  view.findViewById(R.id.bottom_textview);
        bottomTextLayout = view.findViewById(R.id.bottom_text_layout);
